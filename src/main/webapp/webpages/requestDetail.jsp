...
<script>
	...
	$(document).ready(function(){
		var state = 2; //can be 0, 1 or 2
		switch (state){
			case 0: $(".inCorso").removeClass("hidden"); break;
			case 1: $(".inAttesaDiValutazione").removeClass("hidden"); break;
			case 2: $(".done").removeClass("hidden"); break;
		}
	});
</script>
